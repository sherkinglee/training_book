...
We provide a jupyter file for uses to run the codes easily: [notebook](https://github.com/lulab/training_book/tree/649747aaf35571ea69689d1026c63eaa379761eb/files/jupyter/2.1-plot-utilities.ipynb)
...
[https://github.com/adeshpande3/Pandas-Tutorial/blob/master/Pandas Tutorial.ipynb](https://github.com/adeshpande3/Pandas-Tutorial/blob/master/Pandas%20Tutorial.ipynb)
...
use boxplot as an example [https://seaborn.pydata.org/generated/seaborn.boxplot.html](https://seaborn.pydata.org/generated/seaborn.boxplot.html)
...
It is useful to use ipywidgets to tune the parameters to get a perfect plot [https://ipywidgets.readthedocs.io/en/stable/examples/Using Interact.html\#Basic-interact](https://ipywidgets.readthedocs.io/en/stable/examples/Using%20Interact.html#Basic-interact)
...
## display dataframe, std\_plot, pdf\_figure...
...
if sequencing\_type == 'long': plot\_bar\_by\_rna\_total\(percent\_by\_mapped/100.,datatype='ratio'\) else: plot\_bar\_by\_rna\_total\(table\_ratio,datatype='ratio'\)

embed\_pdf\_figure\(\)

if sequencing\_type == 'long': plot\_bar\_by\_rna\_total\(percent\_by\_mapped/100.,datatype='count'\) else: plot\_bar\_by\_rna\_total\(table\_ratio,datatype='count'\)
...
def filter\_mx\(expression\_mx,cutoff\_ratio = 0.2,counts\_threshold = 10 \): retain\_index = np.where\(np.sum\(expression\_mx &gt; counts\_threshold,axis=1\) &gt;=round\(cutoff\_ratio\*expression\_mx.shape\[1\]\)\)\[0\] return expression\_mx.iloc\[retain\_index,:\]
